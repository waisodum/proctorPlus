const examData = {
      ...
      descriptive: [
        {
          ...
          sampleAnswer: "Start with platform selection (Instagram and TikTok primary, YouTube for long-form) based on target demographic (18-35 fitness enthusiasts). Create content pillars: workout tutorials, nutrition tips, success stories, and behind-the-scenes content. Implement a consistent posting schedule (3x/day Instagram, 2x/day TikTok). Use influencer partnerships and user-generated content. Track engagement rates, follower growth, and conversion to app downloads/subscriptions."
        },
        {
          id: "marketing-desc-2",
          question: "Explain how you would measure and improve the ROI of a PPC campaign.",
          sampleAnswer: "Begin by setting clear KPIs: conversion rate, cost per click (CPC), cost per acquisition (CPA), and ROAS. Implement conversion tracking across all channels. Regular A/B testing of ad copy, landing pages, and targeting. Use negative keywords to reduce wasted spend. Optimize bid strategies based on performance data. Track quality score improvements. Regular budget reallocation based on channel performance."
        }
      ],
      domainSpecific: {
        question: "Create a 2-minute video pitch for a new product launch, demonstrating your understanding of value proposition and target audience.",
  ...
  const getQuestionCount = (section) => {
    return section === "mcqs" ? EXAM_CONFIG.mcqCount : EXAM_CONFIG.descriptiveCount;
  };

  export { examData, EXAM_CONFIG, getQuestionCount };
